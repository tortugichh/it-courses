      ...
      <footer className="bg-gray-800 text-white mt-auto">
        <div className="container mx-auto px-4 py-8">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            <div>
              <h3 className="text-lg font-semibold mb-4">TechnoPark Academy</h3>
              <p className="text-sm text-gray-300">
                Empowering professionals with cutting-edge tech skills in AI, Cybersecurity, and Cloud.
              </p>
            </div>
            <div>
            ...
            <div>
              ...
              <p className="text-sm text-gray-300 mb-2">info@technoparkacademy.com</p>
          ...
          <div className="border-t border-gray-700 mt-8 pt-6 text-center text-sm text-gray-300">
            <p>&copy; {new Date().getFullYear()} TechnoPark Academy. All rights reserved.</p>
          </div>
        </div>
      </footer>
    );
